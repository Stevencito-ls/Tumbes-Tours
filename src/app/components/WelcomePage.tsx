          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/90 px-4 py-2 shadow-sm ring-1 ring-slate-200 backdrop-blur-sm">
                ...
                <span className="text-sm font-semibold text-emerald-700">Bienvenido a Tumbes Tours</span>
              </div>
              <div className="space-y-4">
                <h1 className="text-5xl sm:text-6xl font-extrabold tracking-tight text-slate-900">
                  <span className="text-emerald-600">Tumbes Tours</span> — Vive toda la región
                </h1>
                <p className="max-w-2xl text-lg text-slate-600">
                  Paquetes turísticos para conocer toda la Nación Tumbes: playas, manglares, bosque seco, gastronomía y cultura local.
                </p>
              </div>
